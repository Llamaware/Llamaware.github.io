...
// The original source code can be found in https://github.com/greenheartgames/greenworks
// This is a slightly modified version by Basil that just replaces
// the import paths of the binaries.
var fs = require('fs');
...
switch (process.platform) {
  case 'darwin':
    greenworks = require('./lib/osx/greenworks-osx');
    break;
  case 'linux':
    switch (process.arch) {
      case 'x64':
        greenworks = require('./lib/linux/64/greenworks-linux64.node');
        break;
      case 'ia32':
        greenworks = require('./lib/linux/32/greenworks-linux32.node');
        break;
    }
    break;
}
